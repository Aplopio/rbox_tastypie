forked version of django-tastypie for building internal apis. This version enables the following over and above what tastypie allows

1) Nested resources up to any levels
2) Enables the use of resources from a python interface (No http calls involved)
